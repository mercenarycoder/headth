...
public class JsonParser {
    ...
    public String addOtpUser(String url2,String mobile,String otp)
    {
        HttpURLConnection connection = null;
        BufferedReader reader = null;
        ...
        try {
            ...
            JSONObject loginData = new JSONObject();
            loginData.put("number", mobile);
            loginData.put("otp", otp);
            Log.d("LoginData", "---> " + loginData);
            DataOutputStream wr = new DataOutputStream(httpURLConnection.getOutputStream());
            wr.writeBytes(loginData.toString());
            wr.flush();
    ...
    public String checkOtpUser(String url2,String mobile,String otp)
    {
        HttpURLConnection connection = null;
        BufferedReader reader = null;
    ...
    public String deleteOtp(String url2,String number)
    {
        HttpURLConnection connection = null;
        BufferedReader reader = null;
...
//            loginData.put("otp", otp);
 ...
 public String getBulkCalled(String url2,String called){
     HttpURLConnection connection = null;
     BufferedReader reader = null;
 ...
 public String cancelPlasmaRequest(String url2,String caller,String called){
     HttpURLConnection connection = null;
     BufferedReader reader = null;
...
//         loginData.put("caller", caller);
 ...
 public String changeStatus(String url2,String mobile,int status){
     HttpURLConnection connection = null;
     BufferedReader reader = null;
 ...
 public String getHelp(String url2,String age,String blood,String mobile,String pin,String city){
     HttpURLConnection connection = null;
     BufferedReader reader = null;
    ...
    public String getHelpPin(String url2,String age,String blood,String mobile,String pin){
        HttpURLConnection connection = null;
        BufferedReader reader = null;
    ...
    public String getHelpCity(String url2,String age,String blood,String mobile,String city){
        HttpURLConnection connection = null;
        BufferedReader reader = null;
 ...
 public String becomeVolunteer(String url2,String mobile,String pin,String city,
                               String address,String blood,String name,String age)
 {
     HttpURLConnection connection = null;
     BufferedReader reader = null;
 ...
 public String submitCovidData(String url2,String mobile,String path,String type)
 {
     HttpURLConnection connection = null;
     BufferedReader reader = null;
